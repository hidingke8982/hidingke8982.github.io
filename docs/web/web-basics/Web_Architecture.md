...
## Web Server - WAS - DB (3-tier architecture)
...
| Web Application Server  | Tomcat          | Netty            | Uvicorn       |
| Protocol(Interface)     | Jakarta Servlet | Reactive Streams | ASGI          |
| Library(Implementation) | Servlet API     | Reactor          | Starlette     |
| Framework               | Spring MVC      | Spring WebFlux   | FastAPI       |
